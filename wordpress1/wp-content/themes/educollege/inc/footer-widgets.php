...
class Educollege_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'educollege';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'educollege' ), $i ),
...
// Initialize.
$educollege_footer_widgets = new Educollege_Footer_Widgets();
